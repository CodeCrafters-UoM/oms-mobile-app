...
public class Order_card_list extends AppCompatActivity implements Order_card_list_interface {
    ...
    public void OnItemClick(int position) {
        ...
        Log.d(TAG, "return(All: " + String.valueOf(orderCardAdapter.order_cards.get(position).getTotalReturnOrdersForCustomer()));
        Log.d(TAG, "return(order: " + String.valueOf(orderCardAdapter.order_cards.get(position).getTotalOrdersForCustomerForSeller()));
